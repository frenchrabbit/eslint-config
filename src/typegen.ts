...
export type ConfigNames = 'frabbit/global-ignores' | 'frabbit/gitignore' | 'frabbit/js/recommended' | 'frabbit/js' | 'frabbit/comments/recommended' | 'frabbit/comments' | 'frabbit/imports' | 'frabbit/unicorn/unopinionated' | 'frabbit/unicorn' | 'frabbit/sonarjs' | 'frabbit/security' | 'frabbit/node' | 'frabbit/jsdoc' | 'frabbit/regexp' | 'frabbit/de-morgan' | 'frabbit/typescript > typescript-eslint/base' | 'frabbit/typescript > typescript-eslint/eslint-recommended' | 'frabbit/typescript > typescript-eslint/recommended' | 'frabbit/typescript' | 'frabbit/typescript/dts-rules' | 'frabbit/typescript/cjs-rules' | 'frabbit/sort/imports' | 'frabbit/markdown/recommended/plugin' | 'frabbit/markdown/recommended/processor' | 'frabbit/markdown/recommended/code-blocks' | 'frabbit/markdown-rules' | 'frabbit/yaml/setup' | 'frabbit/yaml/rules' | 'frabbit/json' | 'frabbit/sort/package.json' | 'frabbit/sort/tsconfig' | 'frabbit/sort/pnpm-workspace' | 'frabbit/vue/typescript > typescript-eslint/base' | 'frabbit/vue/typescript > typescript-eslint/eslint-recommended' | 'frabbit/vue/typescript > typescript-eslint/recommended' | 'frabbit/vue/typescript' | 'frabbit/vue' | 'frabbit/vue/reactivity-transform' | 'frabbit/unocss' | 'frabbit/prettier' | 'frabbit/command' | 'frabbit/pnpm/package-json' | 'frabbit/pnpm/pnpm-workspace-yaml' | 'frabbit/baseline' | 'frabbit/special/cli' | 'frabbit/special/tests' | 'frabbit/special/allow-default-export' | 'frabbit/special/github' | 'frabbit/special/components'
